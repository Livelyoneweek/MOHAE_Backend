...
public class PostService {
    ...
    public List<DetailPostResponseDto> mypageResponse(Long userId) {
        ...
        System.out.println("test findAllByUserIdAndOrderByCreatedAtDesc");
    ...
    public List<DetailPostResponseDto> mylikeResponse(Long userId) {
        ...
        System.out.println("test findAllByUserIdAndOrderByCreatedAtAsc");
        ...
        //Collections.reverse(detailPostResponseDtoList); 리스트 역순으로 뒤집는 방법
